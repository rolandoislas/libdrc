...
.. raw:: html
	...
	<div class="col-md-6">
		<h3>Mailing list</h3>
		<p><a class="btn btn-default" href="https://mailing.list/libdrc-help"><i class="fa fa-envelope"></i> Support mailing list</a></p>
		<p>Please join the support mailing list for support.</p>
	</div>
	</div>
